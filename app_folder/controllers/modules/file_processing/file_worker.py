...
from db_sqlite.models.model_forms import DesktopQuery, DesktopQueryDelete, DesktopOrderDelete, DesktopItemDelete, DesktopOPDelete, Order, Item, OptionalParameters
...
class FilesController:
    ...
    def get_session(self):
        db = self.db_controller.get_session()
        return db
    # append to json file 
            ...
            with self.db_controller.get_session() as session:
                ...
                if self.cur_method  == 'POST' and self.cur_object == 'Query':
                    ...
                    if query_id:
                        ...
                        query_get = session.get(QueryDB, query_id)
                        ...
                        if query_get:
                            ...
                            try:
                                # for query model
                                obj = QueryDB.model_validate(self.cur_file_data)
                                        ...
                                        for order in value:
                                            ...
                                            if isinstance(order, dict):
                                                ...
                                                if order_id:
                                                    ...
                                                    order_get = session.get(OrderDB, order_id)
                                                    ...
                                                    if order_get:
                                                        ...
                                                        try:
                                                            ...
                                                            obj = OrderDB.model_validate(order)
                                                        ...
                                                        for item in value:
                                                            ...
                                                            if isinstance(item, dict):
                                                                ...
                                                                if item_id:
                                                                    ...
                                                                    item_get = session.get(ItemDB, item_id)
                                                                    ...
                                                                    if item_get:
                                                                        ...
                                                                        try:
                                                                            ...
                                                                            obj = ItemDB.model_validate(item)
                                                                        ...
                                                                        for parameter in value:
                                                                            ...
                                                                            if isinstance(parameter, dict):
                                                                                ...
                                                                                if op_id:
                                                                                    ...
                                                                                    op_get = session.get(OptionalParametersDB, op_id)
                                                                                    ...
                                                                                    if op_get:
                                                                                        ...
                                                                                        try:
                                                                                            ...
                                                                                            obj = OptionalParametersDB.model_validate(parameter)
